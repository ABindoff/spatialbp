...
# Let the latent environmental gradient be the smoothed T1 MRI intensity!
# This represents a continuous anatomical gradient of tissue type.
# We apply a slight spatial smoothing to the latent field to make it clean.
grid_3d$Latent_WM <- grid_3d$T1_MRI

# Simulate corresponding DTI FA channel
set.seed(42)
